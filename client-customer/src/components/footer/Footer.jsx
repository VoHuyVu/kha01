      ...
      <div className="container-80 py-8">
        <Row gutter={[32]} className=''>
          <Col span={24} md={9}>
            ...
            <div >
              <Typography className='text-white mt-1 md:mt-2'>
                Phone.vn is oriented to become the leading e-commerce system selling genuine phones in Vietnam.
              </Typography>
              <Typography className='text-white my-1 md:my-2'>Showroom: 224 Nguyen Van Luong, Go Vap, Ho Chi Minh</Typography>
          ...
          <div className="mt-2 flex space-y-4 justify-center items-center flex-wrap space-x-10 md:space-x-0 md:inline-block">
            ...
            <div className="w-[150px] h-[50px] mt-0 md:mt-5">
              <img className='object-cover ' src="./dmca_copyright_protected150c.png" alt="" />
            </div>
          </div>
          </Col>
        </Row>
